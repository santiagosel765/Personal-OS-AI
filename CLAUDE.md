# CLAUDE.md — Personal OS AI

Este archivo contiene las **instrucciones permanentes** para Claude Code en este repositorio. Léelo antes de cualquier cambio. Si una instrucción aquí entra en conflicto con un prompt puntual, **pregúntame antes** de actuar.
...
1. **No lo hagas.**
2. Explica por qué entra en conflicto con `CLAUDE.md` o con un doc.
